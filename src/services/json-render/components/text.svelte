...
<div class="p-2">
	{#if label}
		<h4 class="text-sm font-bold text-surface-500 uppercase tracking-wider mb-1">{label}</h4>
	{/if}
	<p class="text-base text-surface-900 dark:text-surface-100">{displayValue}</p>
</div>
