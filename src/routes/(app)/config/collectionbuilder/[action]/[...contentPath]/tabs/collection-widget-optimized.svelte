	...
	<div class="flex flex-wrap items-center justify-between gap-3">
		<div class="flex items-center gap-1 rounded-lg bg-surface-100-900 p-1 shadow-inner border border-surface-200-800">
			<button
				...
				class="btn btn-sm flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 transition-all min-h-10 touch-manipulation
		...
		<div class="flex flex-wrap gap-2">
			{#each quickWidgets as qw (qw.key)}
				<button
					...
					class="preset-outlined-surface-500 btn flex items-center gap-1 text-xs hover:preset-filled-primary-500 min-h-9 touch-manipulation"
				>
			...
			<button
				onclick={addField}
				class="preset-filled-secondary-500 btn flex items-center gap-1 text-xs min-h-9 touch-manipulation w-full sm:w-auto sm:ml-auto"
			>
